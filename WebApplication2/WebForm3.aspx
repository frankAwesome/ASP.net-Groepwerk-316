    ...
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Panel ID="Panel1" runat="server" BackColor="#0099FF" Height="86px">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:ImageButton ID="ImageButton2" runat="server" Height="45px" ImageUrl="~/Images/icons8-plus-sign-filled-50.png" OnClick="ImageButton2_Click" Width="45px" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:ImageButton ID="ImageButton3" runat="server" Height="45px" ImageUrl="~/Images/icons8-replace-filled-50WHITE.png" OnClick="ImageButton3_Click" Width="45px" />
            </asp:Panel>
            <br />
